...
paste("Max steps taken in 5 minutes interval in slot", which.max(aggr_interval_steps$steps), "i.e. at", in_times)
...
``` {r}
data1$type_of_day<- as.factor(ifelse (weekdays(as.Date(data1$date)) %in% c('Saturday','Sunday'),"weekend","weekday")) 
